...
label = tk.Label(master=frame, text="X O this game will not be recorded", font=("Arial", 15))
label.pack()
...
label2 = tk.Label(master=frame2, text='Player-1 Turn', bg="skyblue", width=10, height=3, relief=tk.SUNKEN,font=('', 8))
